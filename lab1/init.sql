...
INSERT INTO med_users (login, password, is_moderator, created_at, updated_at) VALUES
('doctor1', 'pass123', false, NOW(), NOW()),           -- Обычный пользователь
('doctor2', 'pass123', false, NOW(), NOW()),           -- Обычный пользователь  
('admin', 'admin123', true, NOW(), NOW()),             -- Модератор
('moderator', 'mod123', true, NOW(), NOW());           -- Модератор

-- Вставка формул ДЖЕЛ
INSERT INTO pvlc_med_formulas (title, description, formula, image_url, category, gender, min_age, max_age, is_active, created_at, updated_at) VALUES
